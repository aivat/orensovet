      ...
      <div class="container">
          <div class="content content-price">
                ...
                <div class="blog-wrapper">
                    ...
                    <h2 class="h2">{{ articleTest.title }}</h2>
                    <div class="annotation">{{ articleTest.annotation }}</div>
                    <div class="text" v-html="articleTest.text"></div>
                    </article>
                </div>
...
header, section, .annotation, .text, .h2 {
    padding: 0px 10px;
}
.annotation {
    font-size: 16px;
